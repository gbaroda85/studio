...
const translations = {
  en: {
    site_title: 'GR7 Multi Tools Kits Hub',
    welcome: 'Welcome to GR7 Multi Tools Kits Hub',
    english: 'English',
    hindi: 'Hindi',
    spanish: 'Spanish',
    language: 'Language',
    ...
    passport_photo_description: 'Create professional passport-sized photos for any country standard.',
    ...
    lock_pdf_description: 'Protect your PDF with secure AES password encryption.',
    ...
    interest_calculator_description: 'Calculate simple and compound interest.',
    ...
    remove_background_description: 'Automatically remove the background from any image.',
    remove_signature_label: 'Remove Signature',
    remove_signature_description: 'Identify and remove signatures from images automatically.',
    enhance_photo_label: 'Enhance Photo',
    enhance_photo_description: 'Improve photo quality, colors, and lighting professionally.',
  ...
  hi: {
    site_title: 'GR7 मल्टी टूल्स किट्स हब',
    welcome: 'GR7 मल्टी टूल्स किट्स हब में आपका स्वागत है',
    english: 'अंग्रेज़ी',
    hindi: 'हिंदी',
    spanish: 'स्पेनिश',
    language: 'भाषा',
    ...
    passport_photo_description: 'किसी भी देश के मानक के लिए पेशेवर पासपोर्ट आकार की तस्वीरें बनाएं।',
    aadhaar_printer_label: 'आधार कार्ड प्रिंटर',
    aadhaar_printer_description: 'ई-आधार को आसान प्रिंटिंग के लिए ऑटो-क्रॉप और व्यवस्थित करें।',
    ...
    interest_calculator_description: 'साधारण और चक्रवृद्धि ब्याज की गणना करें।',
    ...
    remove_background_description: 'किसी भी छवि से पृष्ठभूमि हटाने के लिए स्मार्ट तकनीक का उपयोग करें।',
    remove_signature_label: 'हस्ताक्षर हटाएं',
    remove_signature_description: 'छवियों से हस्ताक्षर पहचानें और स्वचालित रूप से हटाएं।',
    enhance_photo_label: 'फोटो बेहतर बनाएं',
    enhance_photo_description: 'फोटो की गुणवत्ता, रंग और प्रकाश में पेशेवर रूप से सुधार करें।',
    image_to_text_label: 'छवि से टेक्स्ट (ओसीआर)',
    image_to_text_description: 'किसी भी छवि से टेक्स्ट स्थानीय रूप से निकालें।',
  ...
  es: {
    site_title: 'GR7 Multi Tools Kits Hub',
    welcome: 'Bienvenido a GR7 Multi Tools Kits Hub',
    english: 'Inglés',
    hindi: 'Hindi',
    spanish: 'Español',
    language: 'Idioma',
    ...
    passport_photo_description: 'Crea fotos profesionales de tamaño pasaporte para cualquier estándar de país.',
    aadhaar_printer_label: 'Impresora de Tarjetas Aadhaar',
    aadhaar_printer_description: 'Recorte automático y organización de e-Aadhaar para imprimir fácilmente.',
    ...
    lock_pdf_label: 'Locker de PDF Vault',
    lock_pdf_description: 'Proteja sus documentos PDF con cifrado de contraseña AES real.',
    ...
    acceleration_converter_description: 'Convierte entre differentes unidades de aceleración.',
    ...
    pressure_converter_description: 'Convierte entre differentes unidades de presión.',
    ...
    interest_calculator_label: 'Calculadora de Intereses',
    interest_calculator_description: 'Calcula el interés simple y compuesto.',
    sales_tax_calculator_label: 'Calculadora de Impuesto sobre Ventas',
    ...
    remove_background_description: 'Usa tecnología avanzada para quitar el fondo de cualquier imagen.',
    remove_signature_label: 'Quitar firma',
    remove_signature_description: 'Identifica y elimina firmas de imágenes automáticamente.',
    enhance_photo_label: 'Mejorar foto',
    enhance_photo_description: 'Mejora la calidad, los colores y la iluminación de las fotos profesionalmente.',
    image_to_text_label: 'Imagen a Texto (OCR)',
    image_to_text_description: 'Extrae texto de cualquier imagen localmente.',
