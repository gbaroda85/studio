...
const translations = {
  en: {
    ...
    remove_signature_description: 'Extract clean, transparent signatures from photos by removing paper backgrounds.',
  ...
  hi: {
    ...
    remove_signature_label: 'सिग्नेचर BG रिमूवर',
    remove_signature_description: 'पेपर बैकग्राउंड हटाकर फोटो से साफ और पारदर्शी सिग्नेचर निकालें।',
  ...
  es: {
    ...
    scan_to_pdf_label: 'Escannear a PDF',
