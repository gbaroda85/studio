...
const translations = {
  en: {
    ...
    word_to_pdf_description: 'Convert DOCX files to PDF format.',
    pdf_to_word_label: 'PDF to Word',
    pdf_to_word_description: 'Convert PDF files to editable DOCX documents.',
  ...
  hi: {
    ...
    word_to_pdf_label: 'वर्ड से पीडीएफ',
    word_to_pdf_description: 'DOCX फ़ाइलों को PDF प्रारूप में बदलें।',
    pdf_to_word_label: 'पीडीएफ को वर्ड में बदलें',
    pdf_to_word_description: 'पीडीएफ फाइलों को संपादन योग्य DOCX दस्तावेजों में बदलें।',
  ...
  es: {
    ...
    word_to_pdf_description: 'Convierte archivos DOCX a formato PDF.',
    pdf_to_word_label: 'PDF a Word',
    pdf_to_word_description: 'Convierte archivos PDF a documentos DOCX editables.',
