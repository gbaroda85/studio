...
const translations = {
  en: {
    ...
    remove_signature_description: 'Identify and remove signatures from images using AI.',
  ...
  hi: {
    ...
    remove_signature_description: 'AI का उपयोग करके छवियों से हस्ताक्षर पहचानें और हटाएं।',
  ...
  es: {
    ...
    remove_signature_description: 'Identifica y elimina firmas de imágenes usando IA.',
