            ...
            <CardContent className="p-5 md:p-12">
                <div className="border-4 border-dashed border-muted-foreground/20 rounded-[2rem] p-6 md:p-8 flex flex-col items-center justify-center space-y-4 bg-muted/30 group relative">
                    ...
                    <div className="text-center px-4">
                        ...
                        <p className="text-[10px] md:text-sm text-muted-foreground mt-2 font-bold opacity-60 uppercase">High-fidelity local encryption.</p>
                    </div>
                </div>
    ...
    <div className="w-full max-w-7xl animate-in fade-in duration-700 px-4 flex flex-col gap-6">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h2 className="text-lg md:text-2xl font-black uppercase tracking-tighter">Vault <span className="text-primary">Panel</span></h2>
            </div>
        </div>
      </div>
                    ...
                    {protectedBlob ? (
                        ...
                        <div className="w-full max-sm space-y-6 md:space-y-8 text-center">
                            ...
                            <div className="space-y-3 md:space-y-4">
                                ...
                                <p className="text-[8px] md:text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] opacity-50">Local RAM calculation active...</p>
                            </div>
                        </div>
                    ) : (
            ...
            <Card className="glass-panel border-none shadow-2xl overflow-hidden rounded-2xl md:rounded-[2.5rem]">
                ...
                <CardContent className="p-5 md:p-8 space-y-6 md:space-y-8">
                        ...
                        <div className="space-y-3 text-left">
                            ...
                            <div className="relative group">
                                <Input 
                                    ...
                                    className="h-12 md:h-14 font-black text-base border-2 rounded-xl pl-4 pr-12 focus-visible:ring-primary/20 bg-background/50 shadow-inner"
                    ...
                    <div className="p-4 md:p-5 bg-blue-500/5 rounded-xl md:rounded-2xl border-2 border-blue-500/10 flex gap-3 md:gap-4 shadow-sm text-left">
                        ...
                        <div>
                            <p className="text-[10px] md:text-[11px] font-black text-blue-700 uppercase tracking-tight">Security Standard</p>
