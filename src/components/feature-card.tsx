...
export function FeatureCard({
  ...
  return (
    <Link href={href} className="group block h-full">
      <div className="h-full bg-[#fdfdfd] dark:bg-[#0a040d] rounded-[2.5rem] p-2 shadow-[0_15px_35px_-12px_rgba(0,0,0,0.12),0_4px_10px_-5px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] hover:shadow-[0_45px_100px_-20px_rgba(0,0,0,0.25)] dark:hover:shadow-[0_45px_100px_-20px_hsl(var(--primary)/0.4)] transition-all duration-300 hover:-translate-y-3 hover:scale-[1.03] border-2 border-slate-100/80 dark:border-primary/20 flex flex-col transform-gpu shadow-[inset_0_1px_2px_rgba(255,255,255,1)] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] ring-1 ring-black/[0.03]">
