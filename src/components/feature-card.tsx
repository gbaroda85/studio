    ...
    <Link href={href} className="group block h-full">
      <Card className={cn(
        ...
        <CardHeader className="p-6 relative z-10 text-left">
          ...
          <CardTitle className="text-lg font-bold mb-2 leading-tight text-slate-900 dark:text-white group-hover:text-primary transition-colors tracking-tight line-clamp-1 uppercase">{title}</CardTitle>
