...
export default function ResumeBuilder() {
    ...
    return (
        <div className="w-full max-w-[1700px] grid grid-cols-1 lg:grid-cols-12 gap-8 items-start px-4 pb-20">
                                ...
                                <TabsContent value="template" className="space-y-6 mt-0">
                                    ...
                                    <div className="space-y-4 pt-6 border-t">
                                        ...
                                        <Button variant="outline" className="w-full h-12 border-2 border-dashed font-black text-xs uppercase" onClick={() => fileInputRef.current?.click()}>
                                            <ImageIcon className="mr-2 size-4" /> SELECT IMAGE
                                        </Button>
            ...
            {/* SHARED PRINT TARGET - SHARES SAME STATE */}
            <div className="hidden print:block absolute inset-0 z-[99999] bg-white">
            ...
            <style jsx global>{`
                @media print {
                    ...
                    /* The actual container for print */
                    .print-target {
...
function ResumeContent({ data, template, profilePic }: { data: typeof INITIAL_RESUME_DATA, template: string, profilePic: string | null }) {
    const content = () => {
        if (template === 'royal-gold') return <TemplateRoyalGold data={data} profilePic={profilePic} />;
        if (template === 'heritage') return <TemplateHeritage data={data} profilePic={profilePic} />;
        if (template === 'floral') return <TemplateFloral data={data} profilePic={profilePic} />;
        if (template === 'modern-edge') return <TemplateModernEdge data={data} profilePic={profilePic} />;
        return <TemplateCanvaPro data={data} profilePic={profilePic} />;
    }
        ...
        <div className="bg-[#1a1a1a] p-12 text-white flex flex-col" style={{ width: '210mm', minHeight: '297mm' }}>
            ...
            <div className="space-y-12">
                <section className="space-y-4">
                    ...
                    <p className="text-sm leading-relaxed opacity-70 text-justify font-medium">{data.summary}</p>
                </section>
        ...
        <div className="bg-white p-8 flex flex-col" style={{ width: '210mm', minHeight: '297mm', border: '15px solid #800000' }}>
            <div className="border-2 border-[#B8860B] p-8 flex-1 flex flex-col relative">
                <header className="flex flex-col items-center mb-10 text-center gap-4">
                    ...
                    <Separator className="bg-[#B8860B]/30 h-1 my-2" />
...
function TemplateModernEdge({ data, profilePic }: { data: typeof INITIAL_RESUME_DATA, profilePic: string | null }) {
    return (
        <div className="bg-[#0f172a] p-0 flex flex-col text-white" style={{ width: '210mm', minHeight: '297mm' }}>
            <header className="bg-white text-slate-900 p-12 flex items-center justify-between border-b-[10px] border-blue-600">
            ...
            <div className="p-12 grid grid-cols-12 gap-16 flex-1">
