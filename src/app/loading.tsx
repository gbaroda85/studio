...
export default function Loading() {
  return (
    <div className="fixed inset-0 w-full h-full z-[9999] flex flex-col items-center justify-center bg-background/95 backdrop-blur-md animate-in fade-in duration-500">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative size-24 md:size-28 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-primary/30 rounded-[2.5rem] shadow-2xl flex items-center justify-center group overflow-hidden animate-breathing">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
            <div className="flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-muted/50 border border-border/50 shadow-sm">
      ...
      <style jsx>{`
        ...
        @keyframes breathing {
            0%, 100% { transform: scale(1); box-shadow: 0 20px 40px -10px rgba(0,0,0,0.2); }
            50% { transform: scale(1.04); box-shadow: 0 0 25px rgba(var(--primary), 0.15); }
        }
      `}</style>
    </div>
  );
