            ...
            <section className="space-y-10 py-10 border-t">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed text-base md:text-lg font-medium">
                        Our <strong>Professional Studio</strong> uses high-fidelity vector mapping to bundle your images into industrial-grade PDF documents with 100% privacy.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 relative z-10">
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-cyan-400 to-blue-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="font-black uppercase text-sm tracking-widest text-cyan-600">BATCH PROCESSING</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">Upload dozens of images simultaneously. Our engine handles high-volume bundles with ease.</p>
                            </div>
                        </div>
                        ...
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-indigo-400 to-purple-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="font-black uppercase text-sm tracking-widest text-indigo-600">ALIGNED CANVAS</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">Strict A4 frame mapping ensures images are locked to the edges for professional output.</p>
                            </div>
                        </div>
                        ...
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-purple-400 to-pink-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">Your photos stay on your device. All processing happens in local RAM for total security.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="space-y-8 py-10 border-t">
                ...
                <Accordion type="single" collapsible className="w-full max-w-4xl mx-auto">
                    <AccordionItem value="item-1" className="border-b-2 py-2">
                        <AccordionTrigger className="text-xl font-bold text-left">How many images can I convert at once?</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground text-lg leading-relaxed pt-2">
                            You can upload up to **50 images** at once. Since processing happens in your browser's RAM, the only limit is your device's memory. Most modern phones can handle this easily.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2" className="border-b-2 py-2">
                        <AccordionTrigger className="text-xl font-bold text-left">Will the image quality drop in PDF?</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground text-lg leading-relaxed pt-2">
                            No. Our tool uses **High-Density (300DPI)** rendering. We preserve the original pixels and map them to a professional PDF container for a sharp, printable result.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3" className="border-b-2 py-2">
                        <AccordionTrigger className="text-xl font-bold text-left">Is it safe to convert my personal ID photos?</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground text-lg leading-relaxed pt-2">
                            Absolutely. **GR7 Smart Studio** is a client-side web utility. Your images are never uploaded to any server. They are processed entirely within your device's RAM and deleted when you close the tab.
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </section>
