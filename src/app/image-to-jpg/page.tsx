            ...
            <section className="space-y-10 py-10 border-t">
                <div className="text-center space-y-4">
                    <h2 className="text-2xl md:text-5xl font-black uppercase tracking-tight text-slate-800 dark:text-white">
                        Professional JPG Studio
                    </h2>
                    <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed text-base md:text-lg font-medium">
                        Convert images to high-quality JPG format with <strong>Industrial-Grade</strong> pixel mapping and total data privacy.
                    </p>
                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 relative z-10">
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-cyan-400 to-blue-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="font-black uppercase text-sm tracking-widest text-cyan-600">Universal Format</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">Transforms any image into a globally accepted JPG, perfect for application forms and web uploads.</p>
                            </div>
                        </div>
                        ...
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-indigo-400 to-purple-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="font-black uppercase text-sm tracking-widest text-indigo-600">HD Rendering</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">Uses high-fidelity sub-sampling to ensure colors and details remain sharp after conversion.</p>
                            </div>
                        </div>
                        ...
                        <div className="group p-[2px] rounded-[2.5rem] bg-gradient-to-br from-purple-400 to-pink-600 shadow-xl transition-all duration-300 hover:scale-[1.02]">
                            <div className="bg-white dark:bg-slate-900 rounded-[2.4rem] p-8 h-full flex flex-col items-center text-center space-y-4">
                                ...
                                <h3 className="font-black uppercase text-sm tracking-widest text-purple-600">Zero Server Log</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed font-bold uppercase opacity-80">All processing happens in local RAM. Your private photos never leave your device for cloud processing.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="space-y-8 py-10 border-t">
                ...
                <Accordion type="single" collapsible className="w-full max-w-4xl mx-auto">
                    <AccordionItem value="item-1" className="border-b-2 py-2">
                        <AccordionTrigger className="text-xl font-bold text-left">Will the quality drop after converting to JPG?</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground text-lg leading-relaxed pt-2">
                            No. Our tool uses high-quality re-sampling (92% quality threshold) to ensure that the transition from PNG or WEBP to JPG is visually lossless for standard uses.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2" className="border-b-2 py-2">
                        <AccordionTrigger className="text-xl font-bold text-left">Can I convert PNG with transparent background?</AccordionTrigger>
                        <AccordionContent className="text-muted-foreground text-lg leading-relaxed pt-2">
                            Yes, but please note that JPG format does not support transparency. The transparent areas will be automatically filled with a clean white background, which is standard for official documents.
                        </AccordionContent>
                    </AccordionItem>
