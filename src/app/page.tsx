      ...
      <section className="relative w-full max-w-[2000px] pt-8 pb-10 overflow-hidden bg-background dark:bg-[#0a040d] border-b-2 border-border/50 rounded-b-[2.5rem] shadow-[0_45px_100px_-20px_rgba(0,0,0,0.2)] dark:shadow-[0_45px_100px_-20px_rgba(0,0,0,0.7)] mx-auto transition-colors duration-500 z-10">
        ...
        <div className="w-full px-8 md:px-16 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8 animate-fade-in-up">
            ...
            <Link href="/tools?tab=pdf" className="flex items-center gap-4 px-8 py-3 bg-white dark:bg-[#0a041a] border-[3px] border-indigo-500/80 shadow-[0_0_20px_rgba(99,102,241,0.15)] dark:shadow-[0_0_20px_rgba(99,102,241,0.3)] rounded-full hover:shadow-[0_0_30px_rgba(99,102,241,0.3)] dark:hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] transition-all group hover:scale-105 active:scale-95 text-slate-900 dark:text-white">
            ...
            <Link href="/tools?tab=calculator" className="flex items-center gap-4 px-8 py-3 bg-white dark:bg-[#0a041a] border-[3px] border-indigo-500/80 shadow-[0_0_20px_rgba(99,102,241,0.15)] dark:shadow-[0_0_20px_rgba(99,102,241,0.3)] rounded-full hover:shadow-[0_0_30px_rgba(99,102,241,0.3)] dark:hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] transition-all group hover:scale-105 active:scale-95 text-slate-900 dark:text-white">
