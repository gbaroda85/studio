...
const ALL_TOOLS = [
  ...
  { icon: Route, title: "FUEL COST CALCULATOR", description: "Estimate trip fuel expenses and distance.", href: "/fuel-cost-calculator", colorClass: "bg-rose-50", lightBg: "bg-[#fff1f2]", category: "calculator" },
